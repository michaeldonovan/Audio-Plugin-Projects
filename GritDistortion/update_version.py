...
def main():
  ...
  plistpath = scriptpath + "/resources/GritDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GritDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GritDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GritDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GritDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GritDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/GritDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/GritDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/GritDistortion.iss",inplace=1):
