...
def main():
  ...
  plistpath = scriptpath + "/resources/StereoImager-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StereoImager-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StereoImager-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StereoImager-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StereoImager-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StereoImager-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/StereoImager-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/StereoImager.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/StereoImager.iss",inplace=1):
