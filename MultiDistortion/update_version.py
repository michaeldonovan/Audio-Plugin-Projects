...
def main():
  ...
  plistpath = scriptpath + "/resources/MultiDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultiDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultiDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultiDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultiDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MultiDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MultiDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MultiDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MultiDistortion.iss",inplace=1):
