...
def main():
  ...
  plistpath = scriptpath + "/resources/HarmonicExciter-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HarmonicExciter-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HarmonicExciter-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HarmonicExciter-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HarmonicExciter-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/HarmonicExciter-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/HarmonicExciter-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/HarmonicExciter.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/HarmonicExciter.iss",inplace=1):
